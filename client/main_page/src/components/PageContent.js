...
export default function PageContent() {
  ...
  const{posts,getPosts,services,getServices,contacts,getContacts,reservations,getReservations}=context;
    ...
    <>
        <div className="d-flex" id="wrapper">
          ...
          <div id="page-content-wrapper">
            {/* --------------Navbar Begins------------------ */}
            <nav className="navbar navbar-expand-lg navbar-light py-4 px-4" style={{"backgroundColor": "#00028d"}}>
